...
export async function GET(req: NextRequest) {
  try {
    ...
    const res = await fetch(`${API_URL}/users/legitimacy?${queryParams}`, {
      headers: {
    ...
    console.error("users legitimacy GET error:", err)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${API_URL}/users/legitimacy`, {
      method: "POST",
      headers: {
        Accept: "application/json",
